...
t_sqlparse(_Config) ->
    ...
    %% test trim alias
    {ok, Select2} = emqx_rule_sqlparser:parse_select("select payload.x as payload.y from \"topic/#\" where clientid='abc'"),
